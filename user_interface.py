...
#step2
        menu_tabel = MDDataTable(
            ...
            row_date = table_row_data
        )
        menu_tabel.bind(on_check_press=self.checked)
        menu_tabel.bind(on_row_pres=self.on_row_press)
        
        screen.children[0].add_widget(menu_tabel)
        return screen
    ...
    def update_row(self):
        ...
        row_data[index] = update_row_date
