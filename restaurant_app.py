...
from base_model import Restaurant, Client
...
class RestaurantApp:
    ...
    def run_order_process(self):
        ...
        client = Client("Sihana Ejupi", +3897831233)
        ...
        self.calculate_and_print_order_details(restaurant, client, order)

    def calculate_and_print_order_details(self, restaurant, client, order):
